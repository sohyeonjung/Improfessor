...
export default function LoginPage() {
  ...
  const [kakaoUrl, setKakaoUrl] = useState<string>("https://prod.improfessor.kro.kr/oauth2/authorization/kakao");
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (isLocal) {
        const url = new URL('https://prod.improfessor.kro.kr/oauth2/authorization/kakao');
